...
installed on their laptops. During the completion of the final examination,
students may use external sources, including artificial intelligence coding
assistants, provided that they cite these sources and explain how they used them
...
Python programming tools on their laptops. During the completion of a
skill-check, students may use external sources, including artificial
intelligence coding assistants, provided that they cite these sources and
explain how they used them to complete the examination.
...
open-source software project. For each teach assigned to give either a DECO or a
...
evaluation teams will receive a grade for their submitted work. Although
students may use external sources, including artificial coding assistants,
during the completion of their presentation materials, they must cite their
sources. Except for the presentation slides published on the course website, the
presenters may not use any external sources during either the presentation or
...
student will receive a project description for one phrase of the document
...
- **Final Executable Examination**: **One** grade automatically reported at end
...
assessments reports for their skill-checks.
...
**twelve** demonstration assessments and **three** module-level project
assessments.
...
- {{< iconify fa6-solid lightbulb size=18px >}} **Monday**:
  - Document engineering deep-dive presentations by instructor
...
- {{< iconify fa6-solid people-line size=18px >}} **Wednesday**:
  ...
  - Two types of presentations: Document Engineering Concept Overviews (DECO)
  and Document Engineering Project Critiques (DEPC)
...
- {{< iconify fa6-solid gears size=18px >}} **Wednesday Laboratory**:
  - Complete tasks for document engineering tool-building projects
...
GitHub repository or web site. Unless special advance arrangements are made with
...
Students may "spend" up to five "tokens" that they may use to secure seven days
...
document engineering tool-building project. Outside of using these five tokens
or severe, extenuating, and unexpected circumstances that are well documented,
the instructor will not grant any requests for extensions or assignment
re-reassessments.
...
distinct Discord servers for all course discussions. The [Document
Engineering Discord Server](https://discord.gg/5HdxuqjUvK) provides a way for
members of the developer development community to use text and video to chat
with each other and will be the main forum for discussing the professional and
technical content in the field of algorithm analysis. The [Allegheny College
Computer Science Discord Server](https://discord.gg/CS2h9kXzX6) will be the main
forum for Department of Computer Science announcements. Finally, any content
that a student wants the instructor to assess (e.g., the work for an algorithm
