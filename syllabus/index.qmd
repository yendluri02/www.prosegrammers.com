...
- **Class Participation**: Grade reported at conclusion of each of the three
course modules.
...
a Friday classroom session; there are two skill-check assessments for each of the
three course modules.

- **Document Engineering Knowledge-Checks**: Grade reported at conclusion of a
course module; there is one in-person knowledge-check assessment for each of
...
- **Document Engineering Tool Building Projects**: There are two types of these
