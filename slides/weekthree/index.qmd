...
- {{< iconify fa6-solid lightbulb >}} **Object-oriented programming (OOP)** is a
programming paradigm that uses "objects" to represent data and behavior

- {{< iconify fa6-solid lightbulb >}} **OOP helps manage complexity** by breaking up
programs into smaller, reusable pieces like classes and method

- {{< iconify fa6-solid lightbulb >}} **OOP is widely used** in many
