...
# Prosegramming connect

::: {.fragment style="margin-top: -0.15em; font-size: 0.85em;"}

{{< iconify fa6-solid lightbulb >}} **OOP helps us organize document tools**

- Like organizing tools in a toolbox
- Each tool has a specific purpose
- Easy to find and use what you need

:::

::: {.fragment style="margin-top: -0.25em; font-size: 0.85em;"}

{{< iconify fa6-solid book-open >}} **Documents become smart objects**

- A document can remember its title, author, and content
- It can count its own words automatically
- It can generate summaries by itself
...
::: {.fragment style="margin-top: -0.15em; font-size: 1.0em;"}
...
{{< iconify fa6-solid lightbulb >}} **Why inheritance? Code reuse!**
...
{{< iconify fa6-solid lightbulb >}} **Notice**: `TechnicalDocument` gets all `Document` features automatically!
...
{{< iconify fa6-solid magic-wand-sparkles >}} **"Poly" means "many", "morph" means "forms"**

- One action, many different results
- Like pressing a button on different devices:
  - TV remote: changes channel
  - Phone: answers call
  - Door: opens door
...
{{< iconify fa6-solid lightbulb >}} **In programming: same method name, different behavior**

- `process()` method works on any document type
- Each document type does something different
...
{{< iconify fa6-solid calculator >}} **Simple example: different analyzers**
...
# Different analyzer functions (polymorphism!)
def count_words(doc):
    words = doc.content.split()
    return f"'{doc.title}' has {len(words)} words"
...
def find_keywords(doc):
    ...
    return f"'{doc.title}' contains: {', '.join(found)}"

# Create documents
doc1 = Document("Python Guide", "Python is a programming language for data analysis.")
doc2 = Document("Web Tutorial", "Learn HTML, CSS, and JavaScript for web development.")

# Same function call, different results (polymorphism!)
print(count_words(doc1))
print(find_keywords(doc1))
print(count_words(doc2))
print(find_keywords(doc2))
```

::: {.fragment style="margin-top: 0.5em; font-size: 0.9em;"}

{{< iconify fa6-solid lightbulb >}} **Key insight**: Same function name, different behavior based on the document!
...
{{< iconify fa6-solid puzzle-piece >}} **"Has-a" relationship instead of "is-a"**
...
{{< iconify fa6-solid lightbulb >}} **Document generator "has" sections**

- Generator contains multiple sections
- Sections can be added or removed easily
...
class DocumentGenerator:
    def __init__(self, title: str):
        self.title = title
        self.sections = []  # Generator "has" sections
...
{{< iconify fa6-solid lightbulb >}} **Key insight**: Generator is made of smaller parts that work together!
...
{{< iconify fa6-solid shield >}} **Encapsulation**: Protect data
...
{{< iconify fa6-solid magic-wand-sparkles >}} **Polymorphism**: Same action, different results
...
::: {.fragment style="margin-top: 0.1em; font-size: 1.0em;"}

{{< iconify fa6-solid lightbulb >}} **OOP makes document engineering easier**
