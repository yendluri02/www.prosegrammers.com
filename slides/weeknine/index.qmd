...
description: "Master dictionaries in Python programs"
date: "2025-10-13"
date-format: long
...
map document IDs to content, metadata to properties
- {{< iconify fa6-solid code >}} JSON files naturally translate to
dictionaries, making data exchange seamless

:::

## What are dictionaries and why do they matter?
...
## Dictionary with string and integer values
...
- Mix string and integer values in same dictionary
- Keys describe the type of information stored
...
- Dictionary values can be lists of related items
- Useful for organizing hierarchical document structures

:::

## Dictionary mapping to another dictionary
...
# Mapping document IDs to content
...
- Store complete document text as dictionary values
- Access any document instantly by its ID
...
# Dictionary operations for document engineering
...
## Working with JSON document collections
...
## Word frequency analysis with dictionaries
...
## Managing document metadata collections
...
::: {.incremental style="margin-top: 0.1em; font-size: 0.725em;"}
