...
# Document engineering tools must work correctly
...
## Testing document engineering tools establishes confidence in their correctness

::: {.fragment .fade-right}

- Steps during document tool testing:
...
# Testing vs benchmarking for document tools
...
- *What is refactoring?*
    ...
    - **Goal**: Enhance characteristics of document processing tools

- *Why refactor document engineering systems?*
    - **Readability**: Easier for others to understand text processing logic
    - **Maintainability**: Simplifies modifications and debugging
    - **Reusability**: Promotes code reuse across document tools
    - **Performance**: Can sometimes improve text processing efficiency

:::

## What should we test in document tools?
...
## Can you reproduce testing examples from these slides?

::: {.fragment .fade-right style="margin-top: 0.25em; font-size: 0.95em;"}

- Use `www.prosegrammers.com/slides/weeksix/`
- Document testing commands you can try:
    - `poetry install`
    - `poetry run pytest`
    - `poetry run pytest --cov --cov-branch`
    - `poetry run mutmut run`
    - `poetry run mutmut show 16`
- What does output tell you about document tool and/or test quality?
...
## What are the performance trade-offs for document tool testing?

::: {.fragment .fade-right style="margin-top: 0.25em; font-size: 0.95em;"}

- Questions when performing document tool testing:
    ...
    - How can you reduce the cost of:
        ...
        - ... coverage monitoring?
        - ... mutation testing?
- How do you balance costs and benefits of document tool testing?
