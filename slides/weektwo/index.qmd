...
# Document Engineering Skill-Check Guide
...
- **Small programming task** completed on certain Fridays during class
- **Individual assessment** of your Python and document engineering skills
- **GitHub Classroom repository** provided as your starting point
- **Contains `TODO` markers** and blank functions for you to complete
- **Automated checking** ensures your solution meets all requirements
- **Time-limited** completion during the class session

:::

::: {.fragment .fade .boxed-content style="font-size: 0.9em;"}

**Think of it as a focused coding challenge that tests what you've learned!**
...
```bash
# After cloning your skill-check repository from GitHub Classroom
