...
{{< iconify fa6-solid microscope >}} These three concepts form the foundation of all programming logic!
:::
...
```{python}
def format_document_title(title: str, formal: bool) -> str:
    ...
    if formal:
        ...
        result = "Doc: " + formatted_title
    return result

# test both formatting styles
print(format_document_title("user guide", True))
print(format_document_title("user guide", False))
```
...
- The `upper()` method makes text ALL CAPITALS for formal style
- The `title()` method makes text Title Case for informal style
