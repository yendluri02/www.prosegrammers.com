...
- Uses `re` for sentence detection and string methods for word counting
- Provides essential metrics for document quality assessment
...
## Examples of four tools that prosegrammers use for document engineering
...
## Real-world document engineering challenges
...
## Wow, creating and maintaining high-quality documentation for complex projects is very challenging! Why is that?
...
## Wait, what is the document engineering environment?
...
## Document engineering in the time of generative artificial intelligence
...
# How can we setup an effective document engineering environment?
...
## Setting up VS Code for document engineering
...
## Installing Quarto for dynamic documents
...
## Important tools and workflows for prosegrammers
...
## You must have all required tools installed and working! Make sure your document engineering setup is functional!
...
## Overall goals of "document engineering"
