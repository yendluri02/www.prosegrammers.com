---
title: "Software Testing for Document Engineering"
...
- {{< iconify fa6-solid robot >}} **Testing**: Create and run test cases to
confirm document tools produce correct output for sample documents
- {{< iconify fa6-solid flask >}} **Benchmarking**: Measure timing and
performance of document processing operations like parsing or formatting
...
- {{< iconify fa6-solid lightbulb >}} **Answer key questions when testing document tools**:
    - Does the tool correctly parse document formats?
    - After changing code, does processing still work?
- {{< iconify fa6-solid robot >}} **Using assertion statements during testing**:
...
- {{< iconify fa6-solid gears >}} **Why refactor document engineering systems?**
...
- {{< iconify fa6-solid robot >}} **Use test cases to confirm correctness of
refactoring!**
...
- {{< iconify fa6-solid lightbulb >}} **For each document processing function, ask these questions**:
...
::: {.incremental style="margin-top: -0.25em; font-size: 0.915em;"}
...
- {{< iconify fa6-solid rocket >}} **Systems with good designs are easier to
test and maintain**!
...
for sample documents and operations
...
**Always run a small trial first**!
...
::: {.incremental .fade-right style="margin-top: -0.1em; font-size: 0.95em;"}
...
- {{< iconify fa6-solid lightbulb >}} **Yet, can we adopt a more automated
approach to testing? Let's explore the basics of automated testing with
`pytest`! Frameworks make testing easy and repeatable.**
- {{< iconify fa6-solid robot >}} **You can use `uv` to add `pytest` as a project
dependency!**
...
::: {.fragment .fade-right style="margin-top: 0.5em; font-size: 0.8em;"}
...
::: {.fragment .boxed-content .fade-up style="margin-top: 0.25em; font-size: 1.15em;"}
