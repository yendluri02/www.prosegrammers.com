...
- it starts witht the readme 
  - write the readme before any code to define project structure   
-  keeps develpers, contributors and all people in the same loop avoiding problems 
...
- it provides installation steps, including dependencies and enviorment setup 
- it includes usage instructions or exaples so users know how to use or run with the project  
- it also gives credit to the creator/s or contributors 
