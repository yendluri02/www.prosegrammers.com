...
# Lists for document organization

## What we'll cover about lists
...
- {{< iconify fa6-solid edit >}} **Modifying document structures**
  - Add, remove, and reorganize content
  - Update documentation dynamically

- {{< iconify fa6-solid search >}} **Accessing document elements**
...
## Two-dimensional document structures
...
## Summary: lists for document engineering
