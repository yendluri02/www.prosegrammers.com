...
#| autorun: true
#| max-lines: 8
# tuple contains a mutable list as its second element
meta = ("Report", ["draft", "review"])
print("Original meta:", meta)

# attempt to reassign an element of the tuple raises a TypeError
try:
    meta[0] = "Final Report"
except TypeError as e:
    print("Error when trying to reassign tuple element:", type(e).__name__, "-", e)

# however, we can mutate the list contained inside the tuple
meta[1].append("final")
print("Modified meta:", meta)
```
...
print(f"Count of Unique words: {result['total_words']}")
